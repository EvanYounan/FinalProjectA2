...
public class PhotoRenamer {
	...
	File f = new File("src/photo_renamer/imageNodeHandlerInformation.ser");
	Serializing ser = new Serializing("src/photo_renamer/imageNodeHandlerInformation.ser");
		...
		listOfImages.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent arg0) {
				if (listOfImages.getModel().getSize() > 0) {
					...
					statusLabel.setText("Status bar: Please load some images into the program before you do this!");
				}
			}
		});
//		display.setEditable(false);
		...
		frame.addWindowListener(new WindowAdapter() {
		    public void windowClosing(WindowEvent e) {
		        if (listOfImages.getModel().getSize() > 0 || inh.getImages() != null) {
		        	ser.Serialize(inh);
		...
		addTagButton.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				if (!textField.getText().equals("")) {
					...
					statusLabel.setText("Status bar: Please enter a tag to add before you add it!");
				}
			}
			@Override
			public void mouseEntered(MouseEvent e) {
			...
			public void mousePressed(MouseEvent e) {
				if (!textField.getText().equals("")) {
					...
					if (!retrievedTextField.getText().isEmpty()) { 
						ImageNode tempNode = inh.findImageNode(retrievedTextField.getText());
						if (tempNode.findChild(tempNode) != null) {
							if (tempNode.findChild(tempNode).hasTag(tempTag)) {
								inh.removeTag(tempNode.findChild(tempNode), tempTag);
							}	
						}
						retrievedTextField.setText(tempNode.findChild(tempNode).getPathName());
					...
					statusLabel.setText("Status bar: Please enter a tag to remove before you remove it!");
				}
			}
			@Override
			public void mouseEntered(MouseEvent e) {
...
//					Tag tempTag = new Tag(newTagName);
		...
		revertButton.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {
				if (!listOfActivities.isSelectionEmpty()) {
